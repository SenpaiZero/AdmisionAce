...
import com.example.admissionaceapplication.databinding.ActivityNumItemsLogBinding;
import com.example.admissionaceapplication.databinding.ActivityNumItemsMathBinding;

import java.util.ArrayList;

public class NumItemsActivityLog extends AppCompatActivity {

    ActivityNumItemsLogBinding binding;
    ArrayList<SetModel> list;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNumItemsLogBinding.inflate(getLayoutInflater());
        ...
        SetAdapter adapter = new SetAdapter(this,list, "Logic");
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(NumItemsActivityLog.this, MainActivity.class);
